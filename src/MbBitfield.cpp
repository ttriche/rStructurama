/*!
 * \file
 * This file contains the definitions of the functions in the MbBitfield class,
 ...
 *  
 * \brief Definitions for MbBitfield and related operators
 *
 ...
 */
MbBitfield::MbBitfield(int numBits)
    : v(0), m(0), n(0), mask(0), refCount(0) {
 ...
 */
bool MbBitfield::operator==(const MbBitfield &A) const {
 ...
 */
MbBitfield operator!(const MbBitfield &A) {
 ...
 * \param B Second bitfield to compare.
 */
bool operator!=(const MbBitfield &A, const MbBitfield &B) {
 ...
 * data with the copied bitfield, e.g. in MbBitfield B(A.copy()).
 *
 * \brief Create independent copy
 * \return Copy of this.
 */
MbBitfield MbBitfield::copy(void) const {
 ...
 */
MbBitfield &MbBitfield::inject(const MbBitfield &A) {
 ...
 */
std::ostream& operator<<(std::ostream &s, const MbBitfield &A) {
 ...
 */
std::istream& operator>>(std::istream &s, MbBitfield &A) {
 ...
 */
MbBitfield &operator&=(MbBitfield &A, const MbBitfield &B) {
